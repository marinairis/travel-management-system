<template>
  <div class="travel-request-table">
    ...
    >
      ...
      <el-table-column prop="destination" label="Destino" min-width="200" />

      <el-table-column prop="departure_date" label="Data de Ida" width="120" sortable>
        <template #default="scope">
          {{ formatDate(scope.row.departure_date) }}
        </template>
      </el-table-column>

      <el-table-column prop="return_date" label="Data de Volta" width="120" sortable>
        <template #default="scope">
      ...
      <el-table-column v-if="showApprover" prop="approved_by" label="Aprovado Por" min-width="150">
        <template #default="scope">
