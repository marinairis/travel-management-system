...
| Parâmetros por função | máximo 3 |

Ao ultrapassar 200 linhas de template, quebre em subcomponentes com responsabilidade única. Ao ultrapassar 100 linhas em um `.js`, quebre em arquivos com responsabilidade única (não se aplica a `.vue`).
