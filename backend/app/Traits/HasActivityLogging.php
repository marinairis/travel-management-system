...
{
  protected function logActivityCreate(Model $model, string|null $description = null): void
  {
    ActivityLog::create([
      'user_id'    => Auth::id(),
      'action'     => 'create',
  ...
  protected function logActivityUpdate(Model $model, array $oldValues, string|null $description = null): void
  {
    ActivityLog::create([
      'user_id'    => Auth::id(),
      'action'     => 'update',
  ...
  protected function logActivityDelete(Model $model, string|null $description = null): void
  {
    ActivityLog::create([
      'user_id'    => Auth::id(),
      'action'     => 'delete',
